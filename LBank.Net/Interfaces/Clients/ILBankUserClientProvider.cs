namespace LBank.Net.Interfaces.Clients
{
    ...
    /// </summary>
    public interface ILBankUserClientProvider
    {
        /// <summary>
        ...
        void InitializeUserClient(string userIdentifier, LBankCredentials credentials, LBankEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        ILBankRestClient GetRestClient(string userIdentifier, LBankCredentials? credentials = null, LBankEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        ILBankSocketClient GetSocketClient(string userIdentifier, LBankCredentials? credentials = null, LBankEnvironment? environment = null);
    }
}