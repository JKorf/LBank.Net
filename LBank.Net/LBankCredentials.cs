...
namespace LBank.Net
{
    ...
    /// LBank credentials
    /// </summary>
    public class LBankCredentials : ApiCredentials
    {
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
        ...
        public LBankCredentials(string key, string secret)
        {
        ...
        public LBankCredentials(HMACCredential credential)
        {
        ...
        public LBankCredentials(RSAXmlCredential credential)
        {
            Credential = credential;
        }
        ...
        public LBankCredentials(RSAPemCredential credential)
        {
            Credential = credential;
        }
#endif
        ...
        /// <param name="key">API key</param>
        /// <param name="secret">API secret</param>
        public LBankCredentials WithHMAC(string key, string secret)
        {
        ...
        public LBankCredentials WithRSAXml(string key, string privateKey)
        {
            if (Credential != null) throw new InvalidOperationException("Credentials already set");
        ...
        /// <param name="key">API key</param>
        /// <param name="privateKey">Private key</param>
        public LBankCredentials WithRSAPem(string key, string privateKey)
        {
            if (Credential != null) throw new InvalidOperationException("Credentials already set");
        ...
        /// <inheritdoc />
        public override ApiCredentials Copy() => new LBankCredentials { Credential = Credential };
