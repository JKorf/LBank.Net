...
namespace LBank.Net.UnitTests
{
    ...
    internal class SharedRestIntegrationTests
    {
        ...
        private ILBankRestClientSpotApiShared GetSpotRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddLBank(x => x.Rest.OutputOriginalData = true);
            ...
            return sp.GetRequiredService<ILBankRestClient>().SpotApi.SharedClient;
        }
